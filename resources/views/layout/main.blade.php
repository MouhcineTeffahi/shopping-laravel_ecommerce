...
<script type="text/javascript" src="{{URL::asset('dist/js/jquery.js')}}"></script>
<!-- start menu -->
...
<div class="header_top">
	<div class="container">
		<div class="one-fifth column row_1">
         ...
         <div class="cssmenu">
			<ul>
			    <li class="active"><a href="{{url('/login')}}">My Account</a></li>
			</ul>
		 </div>
	</div>
</div>
			...
			<div class="col-xs-8 header-bottom-left">
				...
				<div class="col-xs-6 menu">
		            <ul class="megamenu skyblue">
				      <li class="active grid"><a class="color1" href="index.html">Shirts</a><div class="megapanel">
						<div class="row">
							<div class="col1">
								<div class="h_nav">
									<ul>
	    ...
	    <div class="col-xs-4 header-bottom-right">
	       <div class="box_1-cart">
		     <div class="box_11"><a href="{{route('cart.index')}}">
		      <h4><p>Cart: {{Cart::total()}} (<span id="simpleCart_quantity" class="simpleCart_quantity"></span>{{Cart::count()}} items)</p><img src="{{URL::asset('images/bag.png')}}" alt=""/><div class="clearfix"> </div></h4>
		      </a></div>
